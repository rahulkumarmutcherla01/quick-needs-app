...
// in project/test/core/api/api_service_test.dart.
...
import 'package:project/src/core/storage/token_service.dart' as _i3;
  ...
  _i4.Future<_i7.Uint8List> readBytes(
    ...
    Map<String, String>? headers,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i4.Future<_i7.Uint8List>.value(new _i7.Uint8List(0)),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockTokenService extends _i1.Mock implements _i3.TokenService {
  MockTokenService() {
    _i1.throwOnMissingStub(this);
  }
